...
const UpdateListing = () => {
    ...
    const handleImageSubmit = (e) => {
        if (files.length > 0 && files.length +formData.imageUrls.length< 7) {
            ...
            setImageUploadError('You can only upload 6 images pe listing');
            setUploading(false);
        }
    };
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <div className=" flex gap-4">
                    ...
                    <button disabled={uploading}
                     type='button'onClick={handleImageSubmit} className='p-3 text-green-600 border border-green-600 
                ...
                <button disabled={loading || uploading} className='p-3 pt-2 bg-slate-600 text-white rounded-lg 
